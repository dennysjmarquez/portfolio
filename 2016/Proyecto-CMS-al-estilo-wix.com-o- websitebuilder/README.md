...
            Aun no es soportado el método **Drag drop** de las sesiones estas tiene que ser agregadas manualmente en  el código de la página con su alto, ancho, y posición por el Fontend creador del theme de la página,  el método Drag drop  de las sesiones y la posibilidad de cambiar su alto, ancho, y posición con el mouse es una característica a desarrollar más adelante, el sistema es rápido 100% más que wix.com
